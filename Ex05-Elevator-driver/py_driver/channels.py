class INPUT:
    ...
    BUTTON_FLOORS = [  [UP_BUTTONS[0], DOWN_BUTTONS[0], IN_BUTTONS[0]], 
                       [UP_BUTTONS[1], DOWN_BUTTONS[1], IN_BUTTONS[1]],
                       [UP_BUTTONS[2], DOWN_BUTTONS[2], IN_BUTTONS[2]],
                       [UP_BUTTONS[3], DOWN_BUTTONS[3], IN_BUTTONS[3]] ]
...
class OUTPUT:
    ...
    MOTOR_DIRECTION = [MOTOR_UP, MOTOR_STOP, MOTOR_DOWN]

    UP_LIGHTS      = [LIGHT_UP1, LIGHT_UP2, LIGHT_UP3, LIGHT_UP4]
    DOWN_LIGHTS    = [LIGHT_DOWN1, LIGHT_DOWN2, LIGHT_DOWN3, LIGHT_DOWN4]
    COMMAND_LIGHTS = [LIGHT_COMMAND1, LIGHT_COMMAND2, LIGHT_COMMAND3, LIGHT_COMMAND4]
